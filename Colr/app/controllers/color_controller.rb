class ColorController < UIViewController
  ...
  def viewDidLoad
    ...
    # A Light gray background to separate the Tag table from the Color info
    ...
    # A visual preiview of the actual color
    @color_view = UIView.alloc.initWithFrame [[0, 10], [90, 90]]
    # String#to_color is another handy BubbleWrap addition!
    @color_view.backgroundColor = String.new(self.color.hex).to_color
    self.view.addSubview @color_view

    # Display the hex code of our color
